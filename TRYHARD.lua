...
local WEAPONS_LIST <const> = {
    --[[
    Original table sourced from: https://wiki.rage.mp/index.php?title=Weapons
    Code comments generated by ChatGPT and myself, with additional corrections from https://gta.fandom.com/wiki/Main_Page

    Note: Comments are categorized based on the weapon's release in GTA V, reflecting user experience rather than internal game files.
    ]]
    {
        name = "Melee",
        weapons = {
            -- Base Game (2013)
            {name = "Baseball Bat", hash = 0x958A4A8F},
            {name = "Bottle", hash = 0xF9E6AA4B},
            {name = "Crowbar", hash = 0x84BD7BFD},
            {name = "Flashlight", hash = 0x8BB05FD7},
            {name = "Golf Club", hash = 0x440E4788},
            {name = "Hammer", hash = 0x4E875F73},
            {name = "Hatchet", hash = 0xF9DCBF2D},
            {name = "Knife", hash = 0x99B507EA},
            {name = "Nightstick", hash = 0x678B81B1},
            {name = "Pipe Wrench", hash = 0x19044EE0},
            {name = "Machete", hash = 0xDD5DF8D9},
            {name = "Switchblade", hash = 0xDFE37640},
            {name = "Knuckle Duster", hash = 0xD8DF3C3C},
            {name = "Antique Cavalry Dagger", hash = 0x92A27487},

            -- DLC/Update releases
            {name = "Battle Axe", hash = 0xCD274149},  -- The Doomsday Heist (2017)
            {name = "Pool Cue", hash = 0x94117305},  -- The Doomsday Heist (2017)
            {name = "Stone Hatchet", hash = 0x3813FC08},  -- The Stone Hatchet (2018)
            {name = "Candy Cane", hash = 0x6589186A},  -- Festive Surprise (2017)
            {name = "The Shocker", hash = 0xDAC00025}  -- The Last Dose (2023)
        }
    },
    {
        name = "Handguns",
        weapons = {
            ...
            {name = "Combat Pistol", hash = 0x5EF9FEC4},

            -- DLC/Update releases
            {name = "Pistol .50", hash = 0x99AEEB3B},  -- Independence Day Special (2014)
            {name = "Vintage Pistol", hash = 0x83839C4},  -- The Last Team Standing Update (2014)
            {name = "AP Pistol", hash = 0x22D8FE39},  -- The Heists Update (2015)
            {name = "Flare Gun", hash = 0x47757124},  -- Festive Surprise (2015)
            {name = "Stun Gun (SP)", hash = 0x3656C8C1},  -- Lowriders: Custom Classics (2016)
            {name = "Heavy Pistol", hash = 0xD205520E},  -- Gunrunning (2017)
            {name = "SNS Pistol", hash = 0xBFD21232},  -- The Doomsday Heist (2017)
            {name = "Pistol Mk II", hash = 0xBFE256D4},  -- Gunrunning (2017)
            {name = "SNS Pistol Mk II", hash = 0x88374054},  -- The Doomsday Heist (2017)
            {name = "Marksman Pistol", hash = 0xDC4DB296},  -- The Doomsday Heist (2017)
            {name = "Double-Action Revolver", hash = 0x97EA20B8},  -- The Doomsday Heist (2017)
            {name = "Heavy Revolver", hash = 0xC1B3C3D1},  -- The Doomsday Heist (2017)
            {name = "Heavy Revolver Mk II", hash = 0xCB96392F},  -- The Doomsday Heist (2017)
            {name = "Ceramic Pistol", hash = 0x2B5EF5EC},  -- Arena War (2018)
            {name = "Navy Revolver", hash = 0x917F6C8C},  -- Arena War (2018)
            {name = "Up-n-Atomizer", hash = 0xAF3696A1},  -- Arena War (2018)
            {name = "WM 29 Pistol", hash = 0x1BC4FDB9},  -- The Contract (2021)
            {name = "Perico Pistol", hash = 0x57A4368C},  -- The Cayo Perico Heist (2020)
            {name = "Stun Gun (MP)", hash = 0x45CD9CF3}  -- The Last Dose (2023)
        }
    },
    {
        name = "SMG",
        weapons = {
            -- Base Game (2013)
            {name = "Micro SMG", hash = 0x13532244},
            {name = "SMG", hash = 0x2BE6766B},

            -- DLC/Update releases
            {name = "Mini SMG", hash = 0xBD248B55},  -- High Life Update (2014)
            {name = "Combat PDW", hash = 0xA3D4D34},  -- Gunrunning (2017)
            {name = "SMG Mk II", hash = 0x78A97CD0},  -- Gunrunning (2017)
            {name = "Assault SMG", hash = 0xEFE7E2DF},  -- The Doomsday Heist (2017)
            {name = "Machine Pistol", hash = 0xDB1AA450},  -- Arena War (2018)
            {name = "Unholy Hellbringer", hash = 0x476BF155}  -- The Last Dose (2023)
        }
    },
    {
        name = "Shotguns",
        weapons = {
            -- Base Game (2013)
            {name = "Pump Shotgun", hash = 0x1D073A89},
            {name = "Sawed-Off Shotgun", hash = 0x7846A318},
            {name = "Assault Shotgun", hash = 0xE284C527},
            {name = "Heavy Shotgun", hash = 0x3AABBBAA},

            -- DLC/Update releases
            {name = "Bullpup Shotgun", hash = 0x9D61E50F},  -- High Life Update (2014)
            {name = "Musket", hash = 0xA89CB99E},  -- Independence Day Special (2014)
            {name = "Sweeper Shotgun", hash = 0x12E82D3D},  -- Arena War (2018)
            {name = "Combat Shotgun", hash = 0x5A96BA4},  -- Los Santos Tuners (2021)
            {name = "Pump Shotgun Mk II", hash = 0x555AF99A},  -- Gunrunning (2017)
            {name = "Double Barrel Shotgun", hash = 0xEF951FBB}  -- The Doomsday Heist (2017)
        }
    },
    {
        name = "Assault Rifles",
        weapons = {
            -- Base Game (2013)
            {name = "Assault Rifle", hash = 0xBFEFFF6D},
            {name = "Carbine Rifle", hash = 0x83BF0278},
            {name = "Advanced Rifle", hash = 0xAF113F99},

            -- DLC/Update releases
            {name = "Special Carbine", hash = 0xC0A3098D},  -- Business Update (2015)
            {name = "Bullpup Rifle", hash = 0x7F229F94},  -- High Life Update (2014)
            {name = "Compact Rifle", hash = 0x624FE830},  -- Lowriders: Custom Classics (2016)
            {name = "Assault Rifle Mk II", hash = 0x394F415C},  -- Gunrunning (2017)
            {name = "Carbine Rifle Mk II", hash = 0xFAD1F1C9},  -- Gunrunning (2017)
            {name = "Special Carbine Mk II", hash = 0x969C3D67},  -- Gunrunning (2017)
            {name = "Bullpup Rifle Mk II", hash = 0x84D6FAFD},  -- Gunrunning (2017)
            {name = "Military Rifle", hash = 0x9D1F17E6},  -- The Contract (2021)
            {name = "Heavy Rifle", hash = 0xC78D71B4},  -- The Criminal Enterprises (2022)
            {name = "Service Carbine", hash = 0xD1D5F52B},  -- Los Santos Tuners (2021)
            {name = "Battle Rifle", hash = 0x72B66B11}  -- San Andreas Mercenaries (2023)
        }
    },
    {
        name = "Machine Guns",
        weapons = {
            ...
            {name = "Combat MG", hash = 0x7FD62962},

            -- DLC/Update releases
            {name = "Gusenberg Sweeper", hash = 0x61012683},  -- Valentine's Day Massacre Special (2014)
            {name = "Combat MG Mk II", hash = 0xDBBD7280},  -- Gunrunning (2017)
            {name = "Tactical SMG", hash = 0x14E5AFD5}  -- San Andreas Mercenaries (2023)
        }
    },
    {
        name = "Sniper Rifles",
        weapons = {
            -- Base Game (2013)
            {name = "Sniper Rifle", hash = 0x5FC3C11},
            {name = "Heavy Sniper", hash = 0xC472FE2},

            -- DLC/Update releases
            {name = "Marksman Rifle", hash = 0xC734385A},  -- Last Team Standing (2014)
            {name = "Heavy Sniper Mk II", hash = 0xA914799},  -- Gunrunning (2017)
            {name = "Marksman Rifle Mk II", hash = 0x6A6C02E0},  -- Doomsday Heist (2017)
            {name = "Precision Rifle", hash = 0x6E7DDDEC}  -- Criminal Enterprises (2022)
        }
    },
    {
        name = "Heavy Weapons",
        weapons = {
            ...
            {name = "Grenade Launcher", hash = 0xA284510B},
            {name = "Minigun", hash = 0x42BF8A85},
            {name = "Railgun (SP)", hash = 0x6D544C99},

            -- Removed or Replaced (Special Case)
            {name = "RPG (Stinger)", hash = 0x687652CE},
            -- {name = "Tear Gas Launcher", hash = 0x4DD2DC56},

            -- DLC/Update releases
            {name = "Firework Launcher", hash = 0x7F7497E5},  -- Independence Day Special (2014)
            {name = "Homing Launcher", hash = 0x63AB0442},  -- Festive Surprise (2014)
            {name = "Snowball Launcher", hash = 0x3BF5575},  -- Festive Surprise (2015)
            {name = "Compact Grenade Launcher", hash = 0x781FE4A},  -- Gunrunning (2017)
            {name = "Widowmaker", hash = 0xB62D1F67},  -- Arena War (2018)
            {name = "Compact EMP Launcher", hash = 0xDB26713A},  -- Los Santos Tuners (2021)
            {name = "Railgun (MP)", hash = 0xFEA23564}  -- Gun Van Update (2023)
        }
    },
    {
        name = "Throwables",
        weapons = {
            ...
            {name = "Sticky Bomb", hash = 0x2C3731D9},
            {name = "Pipe Bomb", hash = 0xBA45E8B8},
            {name = "Ball", hash = 0x23C9F95C},

            -- DLC/Update Releases
            {name = "BZ Gas", hash = 0xA0973D5E},  -- The Lost and Damned (2014)
            {name = "Tear Gas", hash = 0xFDBC8A50},  -- The Lost and Damned (2014)
            {name = "Flare", hash = 0x497FACC3},  -- Festive Surprise (2014)
            {name = "Snowball", hash = 0x787F0BB},  -- Festive Surprise (2015)
            {name = "Proximity Mine", hash = 0xAB564B93},  -- Lowriders: Custom Classics (2016)
            {name = "Hazardous Jerry Can", hash = 0xBA536372},  -- The Doomsday Heist (2017)
            {name = "Jerry Can", hash = 0x34A67B97},  -- The Doomsday Heist (2017)
            {name = "Fertilizer Can", hash = 0x184140A1},  -- Los Santos Tuners (2021)
            {name = "Acid Package", hash = 0xF7F1E25E}  -- The Criminal Enterprises (2022)
        }
    },
    {
        name = "Misc",
        weapons = {
            -- Base Game (2013)
            {name = "Fire Extinguisher", hash = 0x60EC506},
            {name = "Parachute", hash = 0xFBAB5776},

            -- DLC/Update releases
            {name = "Metal Detector", hash = 0xDBA2E809},  -- The Criminal Enterprises (2022)
            {name = "Hacking Device", hash = 0x1CF5FA48}  -- The Chop Shop (2023)
        }
    }
}
...
local function is_player_free_aiming_with_crosshair_reticle(playerID, playerPed)
    ...
    if NATIVES.PED.GET_PED_CONFIG_FLAG(playerPed, PCF.IsAimingGun, true) then
        if
            NATIVES.PED.GET_PED_RESET_FLAG(playerPed, PRF.SkipAimingIdleIntro)
        then
            return false
        end
        return true
...
-- TODO: Load and Save to settings file
-- TODO2: technically some new code need to be implemented on charachter switch (reset playerWeaponsBackup)
local autoUnequipWeapons_Feat = menu.add_feature("Auto Unequip Weapons", "parent", myRootMenu_Feat.id)

local playerWeaponsBackup = {}

for i1, weaponGroup in ipairs(WEAPONS_LIST) do
    local groupMenu = menu.add_feature(weaponGroup.name, "parent", autoUnequipWeapons_Feat.id)

    for i2, weapon in ipairs(weaponGroup.weapons) do
        feat = menu.add_feature(weapon.name, "toggle", groupMenu.id, function(feat)
            local playerPed = player.player_ped()
            ...
            while feat.on do
                ...
                if NATIVES.WEAPON.HAS_PED_GOT_WEAPON(playerPed, weaponHash, false) then
                    playerWeaponsBackup[weaponHash] = true
                    NATIVES.WEAPON.REMOVE_WEAPON_FROM_PED(playerPed, weaponHash)
                end
            end

            if not feat.on then
                if playerWeaponsBackup[weaponHash] then
                    NATIVES.WEAPON.GIVE_WEAPON_TO_PED(playerPed, weaponHash, 0, false, false)
                    playerWeaponsBackup[weaponHash] = nil
                end
            end
        end)
        feat.hint = "Removes this weapon from your inventory.\n\nNote:\nIt will be restored after untoggling."
    end
end
